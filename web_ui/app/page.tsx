...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isKmode) {
      ...
      let aeroBodyClass = 'research_exposed';
      if (p.airframe_class === 'ConsumerFolding' || p.airframe_class === 'MicroAIO') {
        aeroBodyClass = 'commercial_compact';
      } else if (p.airframe_class === 'EnterpriseRugged' || p.airframe_class === 'Agricultural') {
        aeroBodyClass = 'commercial_bulky';
      }
      ...
      submissionFormData.append('aero_body_class', aeroBodyClass);
          ...
          <div className="panel">
            ...
            <div style={{ background: 'var(--bg-color)', padding: '1.5rem', borderRadius: '4px', border: '1px solid var(--border)', marginTop: '1rem' }}>
              ...
              <div className="form-grid" style={{ marginBottom: 0 }}>
                ...
                <div className="form-group" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <label>Propeller Class</label>
                  <select name="propeller_class" defaultValue="SF" style={{ padding: '0.5rem', borderRadius: '4px', border: '1px solid var(--border)', background: 'var(--bg-color)', color: 'var(--text-color)' }}>
                    <option value="SF">Slow Flyer (SF) [Default]</option>
                    <option value="TE">Thin Electric (TE)</option>
                ...
                <div className="form-group">
                  <label>Propeller Blade Count</label>
                  <input type="number" name="num_blades" step="1" min="2" max="8" placeholder="Auto (2)" />
                </div>
                <div className="form-group" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
