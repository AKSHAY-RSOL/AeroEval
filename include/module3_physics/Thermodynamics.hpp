...
namespace Module3 {
    ...
    private:
        static constexpr double PWM_FREQUENCY_HZ = 24000.0;     // ESC PWM switching frequency (Hz). Standard for large-prop ESCs; matches reported model value.
        static constexpr double CP_LITHIUM_J_KG_K = 1000.0;    // Lithium-polymer pack specific heat capacity (J/(kg·K)); literature range 900-1100.
